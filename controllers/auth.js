...
exports.signin = (req, res) => {
    ...
    User.findOne({ email }, (err, user) => {
        ...
        // gengerate a token with userId and secret from .env
...
exports.forgotPassword = (req, res) => {
    ...
    User.findOne({ email }, (err, user) => {
        ...
        const emailData = {
            ...
            html: `<p>Please use the following link to reset your password: ${process.env.CLIENT_URL
...
// first you will find the user in the database with user's resetPassword
